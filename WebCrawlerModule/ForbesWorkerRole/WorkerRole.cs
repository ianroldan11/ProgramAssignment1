...
namespace ForbesWorkerRole
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        {
            Trace.TraceInformation("ForbesWorkerRole is running");
        ...
        {
            Trace.TraceInformation("ForbesWorkerRole is stopping");
            ...
            Trace.TraceInformation("ForbesWorkerRole has stopped");
        }
        ...
        private static readonly string KeyIdentifier = "Forbes";
