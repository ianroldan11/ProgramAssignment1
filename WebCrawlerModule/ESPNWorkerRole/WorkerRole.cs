...
namespace ESPNWorkerRole
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        {
            Trace.TraceInformation("ESPNWorkerRole is running");
        ...
        {
            Trace.TraceInformation("ESPNWorkerRole is stopping");
            ...
            Trace.TraceInformation("ESPNWorkerRole has stopped");
        }
        ...
        private static readonly string KeyIdentifier = "ESPN";
        ...
        private static void PerformInitialSetUp()
        {
            ...
            AzureStorageManager.AddUrlToQueue("http://www.espn.com/nba/");
        }
